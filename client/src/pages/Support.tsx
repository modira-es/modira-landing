      ...
      >
        <nav className="container mx-auto h-[80px] pl-10 pr-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex flex-1 justify-center items-center px-8">
            ...
            >
              ¿Necesitas ayuda? Abre un ticket y nuestro equipo te asistirá.
            </span>
          </div>
          ...
          >
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <DialogHeader>
                ...
                <DialogDescription>
                  Describe tu problema detalladamente y nos pondremos
        ...
        {loading ? (
          ...
          <Card className="p-12 text-center border-dashed border-2 border-[#E8ECF2] bg-[#F4F6F9]">
            ...
            <p className="text-[#52627A] mt-2 max-w-sm mx-auto">
              Si necesitas ayuda con cualquier aspecto de la plataforma,
              abre un ticket y nuestro equipo te asistirá.
            </p>
          ...
          <div className="space-y-4">
            ...
            {filteredTickets.map((ticket) => (
              ...
              <Card
                key={ticket.id}
                className="p-6 border border-[#E8ECF2] hover:border-[#173B8F] hover:shadow-lg transition-all"
              >
                ...
                <div className="flex flex-col md:flex-row justify-between gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <Button
                      variant="outline"
                      className="w-full md:w-auto border-[#E8ECF2] text-[#173B8F] hover:bg-[#173B8F]/5"
                    >
                      Ver Conversación
                    </Button>
